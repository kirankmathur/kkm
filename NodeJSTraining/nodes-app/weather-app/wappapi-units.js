...
const url = 'http://api.weatherstack.com/current?access_key=d69a7070827d14e1f187f97d428a9dab&query=13.0827,80.2707&units=f'
...
request({url: url, json: true}, (error, response) => {
    ...
    console.log(" Weather is currently-->  "+currentObj.weather_descriptions[0]+ " \n")
